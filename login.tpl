...
<div class="p_login">
  ...
  // ****************  </div>
    ...
    <div class="p_login_bottom">
        ...
        <a id="powered_by" href="https://www.refex.co.in/pdf/Privacy-Policy.pdf" class="legal" target="_blank" rel="noreferrer noopener">Privacy policy</a>
    <a id="powered_by" href="https://refex.co.in" target="_blank" rel="noreferrer noopener" class="entity-name">Refex Group of Companies</a>
